...
Welcome to the Wordpress-start-kit development repository! 

Please check out the [contributor handbook](https://make.wordpress.org/core/handbook/) for information about how to open bug reports, contribute patches, test changes, write documentation, or get involved in any way you can.
...
You will need MAMP (if you use macOS) or OpenServer (if you use Windows) and npm installed on your computer.
...
Clone the current repository using `git clone https://github.com/*link*/`. Then in your terminal move to the repository folder `cd wordpress-develop` and run the following commands:
